...
public class TesteExercicios {
	...
	public static void main(String[] args) {
		...
		exercicios abdominalSupra = new exercicios("Abdominal supra", 0, 0," https://youtu.be/t4PBYd481nk ",0,0,1,1);
		exercicios flexaoDeBraco = new exercicios("Flexão de Braço", 0, 0," https://youtu.be/lkvSelJ0tQ8", 0,1,1,1);
		exercicios agachamentoSumo = new exercicios("Agachamento Sumô", 0, 0," https://youtu.be/XypoxVWr0zs ", 0,1,0,1);
		exercicios ponte = new exercicios("Ponte", 0, 0," https://youtu.be/7mcMQiy-MWQ ", 0,0,1,1);
		exercicios agachamentoCadeira = new exercicios("Agachamento livre na cadeira", 0, 0," https://youtu.be/5HgLKPl4Wx4 ", 0,0,1,1);
		exercicios tricepsBanco = new exercicios("Triceps no banco", 0, 0," https://youtu.be/GM21qkns-Ao  ", 0,1,0,1);
		exercicios corridaEstacionaria = new exercicios("corridaEstacionaria", 00, 0," https://youtu.be/pvLUTrZFvi4 ", 0,0,1,0);
		exercicios oGato = new exercicios("Mobilidade toraxica O Gato", 0, 0," https://youtu.be/comObBAaUjc  ", 00,0,1,0);
		exercicios agachamentoIsometrico = new exercicios("Agachamento isometrico na parede", 0, 0," https://youtu.be/p1KsWs_SNjg ",00,0,1,0);
		exercicios agachamentoSalto = new exercicios("Agachamento com salto", 0, 0," https://youtu.be/p6miSld2sGs ", 0,0,1,1);
		exercicios stiffUnilateral = new exercicios("stiffUnilateral", 00, 0," https://youtu.be/2l5cKMBRUU4 ", 0,1,0,1);
		exercicios escalador = new exercicios("Escalador", 00, 0," https://youtu.be/Eni-G2H-WUA ", 0,0,1,0);
		exercicios abdominalRemador = new exercicios("Abdominal Remador", 0, 0," https://youtu.be/xvS-hw6dEGI ", 0,0,1,1);
		exercicios polichinelos = new exercicios("Polichinelos", 0, 0," https://youtu.be/dJFfySv3tUg ", 0,0,1,0);
		exercicios elevacaoPes = new exercicios("Elevacao na ponta dos pés", 0, 0," https://youtu.be/huMhUr8Qycs ", 0,1,0,0);
		exercicios pulaCordas = new exercicios("Pula Cordas", 0, 0," https://youtu.be/IcstXRKX2_Y ", 0,0,1,0);
		exercicios abdominalBicicleta = new exercicios("Abdominal Bicicleta", 0, 0," https://youtu.be/E07kQpNXTNA ", 0,0,1,0);
